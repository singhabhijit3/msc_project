...
l1 = LSTM(hidden_size, return_sequences=True, dropout=0.5, recurrent_dropout=0.5)(d1)
if use_dropout:
    d2 = Dropout(0.5)(l1)
l2 = LSTM(hidden_size, return_sequences=True, dropout=0.5, recurrent_dropout=0.5)(d2)
if use_dropout:
    d3 = Dropout(0.5)(l2)
